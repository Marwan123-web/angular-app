...
export class AddStudentGradeComponent implements OnInit {
  ...
  addStudentGrade(studentId: HTMLInputElement, score: HTMLInputElement) {
      ...
      this.adminservices.addSemesterStudentGrade(this.currentCourse.courseCode, this.studentId,this.currentCourseSemester.semesters[0].semester_time, this.gradeType, this.score).subscribe(res => {
        this.response = res;
